...
**[Buy Now with UPTO 75% OFF](https://www.asanaplugins.com/product/woocommerce-dynamic-pricing-and-discounts-plugin/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link)**
...
* Update: Verified compatibility with WooCommerce 10.3.6

= 9.2.0 - 24-11-2025 =
* New: Added recurring discount types for the WooCommerce subscriptions plugin.

= 9.1.1 - 18-11-2025 =
* Fix: Fixed an issue in getting customer bought products.
* Fix: Fixed select2 deprecated message issue in woocommerce 10.3.
* Fix: Fixed analytics disabled issue for counting impressions.
...
* Update: Verified compatibility with WooCommerce 10.2.2
...
= 8.22.0 - 07-08-2025 =
* New: Added "Cart discount rules" support to the "Coupons applied" condition.
* Update: Verified compatibility with WooCommerce 10.0.4.

= 8.21.0 - 07-07-2025 =
* New: Added a "Buy x Get x - same product" option to create Buy One Get One deals for the same product with a single rule.
...
= 8.20.1 - 28-05-2025 =
* Fixed regular price issue in WholeSale Prices plugin compatibility.
...
= 8.19.1 - 02-05-2025 =
* Fixed the live price compatibility issue with Extra Product Options.
* Verified compatibility with WooCommerce version 9.8.3.

= 8.19.0 - 22-04-2025 =
* Added usage restrictions to the rules.
* Added usage restrictions per user to the rules.
* Verified compatibility with WooCommerce version 9.8.1.
...
* Updated the plugin update library.
...
= 8.18.0 - 10-12-2024 =
* Checkout Fees adjusted to consider if the subtotal includes or excludes tax based on cart configuration.
...
= 8.15.0 - 30-09-2024 =
* Resolved an issue with manual coupons.
* Fixed a pricing update issue for bulk pricing rules in simple products.
...
* Verified compatibility with WooCommerce version 9.3.1.
...
* Verified compatibility with WooCommerce version 9.2.3.
...
* Verified compatibility with WooCommerce version 9.0.2.

= 8.11.0 - 13-06-2024 =
* Added an option to Enable/Disable free gift emoji 🎁 in the cart and checkout.
* Fixed free gift emoji styles.

= 8.10.0 - 11-06-2024 =
* Added compatibility for auto-added products with cart and checkout blocks.
* Added a free gift emoji 🎁 to the free items in the cart and checkout.
* Added WPML compatibility for cart items categories, tags, attributes, and taxonomies conditions.
* Fixed issues with categories, tags, attributes, and taxonomies in cart conditions.
* Verified compatibility with WooCommerce version 8.9.3.

= 8.9.0 - 05-06-2024 =
* Fixed an issue in grouped product discount types.
* Fixed the discounted products shortcode issue with WPML multilingual.
* Verified compatibility with WooCommerce version 8.9.2.
...
= 8.7.1 - 20-04-2024 =
* Fixed change product price issue with bulk pricing rules on product page.
...
= 8.6.2 - 19-03-2024 =
* Resolved problems with verifying quantity according to category.
* Address an issue with verifying the auto-add rule.

= 8.6.1 - 17-03-2024 =
* Resolved issues related to changing product prices on the product page to accommodate bulk pricing rules.

= 8.6.0 - 13-03-2024 =
* Implemented a feature allowing modification of product prices using bulk pricing rule ranges.
* Integrated WooCommerce on-sale products into the [wccs_discounted_products] shortcode.
