...
/**
 * @wordpress-plugin
 * Plugin Name: Easy Product Bundles Pro for WooCommerce
 ...
 * Text Domain: asnp-easy-product-bundles-pro
...
use AsanaPlugins\WooCommerce\ProductBundlesPro\Plugin;

// Plugin version.
if ( ! defined( 'ASNP_WEPB_PRO_VERSION' ) ) {
	define( 'ASNP_WEPB_PRO_VERSION', '6.15.0' );
}
	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
		error_log(  // phpcs:ignore
			sprintf(
				...
				esc_html__( 'Your installation of the Easy Product Bundles Pro plugin is incomplete. Please run %1$s within the %2$s directory.', 'asnp-easy-product-bundles-pro' ),
				'`composer install`',
 ...
 *
 * Example: <?php $plugin = ASNP_WEPB_PRO(); ?>
 *
 * @since  1.0.0
 * @return object|Plugin The one true Plugin Instance.
 */
function ASNP_WEPB_PRO() {
